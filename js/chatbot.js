(function () {
  ...
  var sections = [
    ...
    { name: 'contact', keywords: ['contact', 'reach', 'email', 'phone', 'call', 'message', 'form', 'get in touch', 'quote'], content: 'Use the on-site contact form (full name, location, mobile number, select a service, message), the floating WhatsApp button, or social media (TikTok, Facebook, Snapchat, Instagram, LinkedIn).' },
